...
1. **Graph Clustering via Similarity Aware Embeddings with an MLP-based Learning Strategy**<br>
   `ACM SAC 2026` · acceptance rate ~23.4%
2. **G-DMoNLite: A Novel Modularity-Based Approach for Graph Clustering**<br>
   `IEEE IC2SDT 2025`
3. **Multi-Scale Diffusion Enhancement for Graph Clustering with Heat and PPR Kernels**<br>
   `ACM IKDD CODS 2025`
4. **Attributed Modularity Loss for Improved Graph Clustering**<br>
   `ACM IKDD CODS 2025`
5. **Classification of Plant Disease using a State-of-the Art Deep Learning Algorithm on a Tesla GPU**<br>
...
Master's student in Computer Science at **NIT Rourkela**, passionate about Graph Neural Networks and Machine Learning.

- **Research** -- Deep Learning, Graph Clustering, GNNs, Graph Distillation
- **Development** -- C++, Go, MERN stack
- **Teaching Assistant** -- Machine Learning, NIT Rourkela
...
Built agentic AI and deep-learning pipelines for Scene Text Recognition on real-world images. Fine-tuned LLMs and VLMs for on-device inference, and implemented the text localization and preprocessing stack in OpenCV.
